...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React27 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is2, useState4 = React27.useState, useEffect12 = React27.useEffect, useLayoutEffect = React27.useLayoutEffect, useDebugValue = React27.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React27 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is2, useSyncExternalStore2 = shim.useSyncExternalStore, useRef9 = React27.useRef, useEffect12 = React27.useEffect, useMemo5 = React27.useMemo, useDebugValue = React27.useDebugValue;
...
var selectorChartsItemIsFocused = createSelector2(selectKeyboardNavigation, (keyboardNavigationState, item) => keyboardNavigationState?.item != null && fastObjectShallowCompare(keyboardNavigationState.item, item));
...
var selectorChartsFocusedItem = createSelector2(selectKeyboardNavigation, (keyboardNavigationState) => keyboardNavigationState?.item ?? null);
...
var selectorChartsTooltipPointerItem = createSelector2(selectTooltip, (tooltip) => tooltip?.item ?? null);
...
var useChartAnimation = ({
  ...
  const disableAnimation = React10.useCallback(() => {
...
var useChartInteractionListener = ({
  ...
  const gestureManagerRef = React12.useRef(null);
  React12.useEffect(() => {
  ...
  const addInteractionListener = React12.useCallback((interaction, callback, options) => {
    const svg = svgRef.current;
  ...
  const updateZoomInteractionListeners = React12.useCallback((interaction, options) => {
    const svg = svgRef.current;
    const gestureManager = gestureManagerRef.current;
...
function useCharts(inPlugins, props, seriesConfig) {
  const chartId = useId();
  const plugins = React13.useMemo(() => [...CHART_CORE_PLUGINS, ...inPlugins], [inPlugins]);
  const pluginParams = extractPluginParamsFromProps({
    plugins,
    props
  });
  pluginParams.id = pluginParams.id ?? chartId;
  const instanceRef = React13.useRef({});
  const instance = instanceRef.current;
  const publicAPI = useChartApiInitialization(props.apiRef);
  const innerChartRootRef = React13.useRef(null);
  const innerSvgRef = React13.useRef(null);
...
function useChartApiInitialization(inputApiRef) {
  const fallbackPublicApiRef = React13.useRef({});
  if (inputApiRef) {
...
var tooltipItemPositionGetter4 = (params) => {
  ...
  const layout = seriesLayout2.pie?.[identifier.seriesId];
...
function useAnimateInternal(props, {
  ...
  const setRef = React18.useCallback((element) => {
    if (element === null) {
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime4.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime4.jsxs)(React24.Fragment, {
...
function ChartsContinuousGradientObjectBound(props) {
  ...
  const keyPrefix = `${extremumValues[0]}-${extremumValues[1]}-`;
  return (0, import_jsx_runtime6.jsx)("linearGradient", _extends({
    id: gradientId
    ...
    children: Array.from({
      ...
      return (0, import_jsx_runtime6.jsx)("stop", {
        offset,
        stopColor: color2,
        stopOpacity: 1
      }, keyPrefix + index2);
...
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime7.jsxs)("defs", {
    children: [filteredYAxisIds.map((axisId) => {
      ...
      if (colorMap?.type === "piecewise") {
        return (0, import_jsx_runtime7.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse2,
          scale,
          colorMap,
          size: svgHeight,
      ...
      if (colorMap?.type === "continuous") {
        return (0, import_jsx_runtime7.jsxs)(React25.Fragment, {
          children: [(0, import_jsx_runtime7.jsx)(ChartsContinuousGradient, {
            isReversed: !reverse2,
            scale,
            colorScale,
            colorMap,
            ...
            gradientId,
            direction: "y"
          }), (0, import_jsx_runtime7.jsx)(ChartsContinuousGradientObjectBound, {
            isReversed: reverse2,
            colorScale,
            colorMap,
      ...
      if (colorMap?.type === "continuous") {
        return (0, import_jsx_runtime7.jsx)(ChartsContinuousGradientObjectBound, {
          colorScale,
          colorMap,
          gradientId: objectBoundGradientId
...
var _excluded4 = ["children", "className", "title", "desc"];
...
var ChartsSurface = React26.forwardRef(function ChartsSurface2(inProps, ref) {
  const store = useStore2();
  ...
  return (0, import_jsx_runtime8.jsxs)(ChartsSurfaceStyles, _extends({
    ownerState: {
      width: propsWidth,
      height: propsHeight,
      hasZoom
    ...
    ref: handleRef,
    children: [title && (0, import_jsx_runtime8.jsx)("title", {
      children: title
    }), desc && (0, import_jsx_runtime8.jsx)("desc", {
      children: desc
    }), (0, import_jsx_runtime8.jsx)(ChartsAxesGradients, {}), hasIntrinsicSize && children]
  }));
});
...
//# sourceMappingURL=chunk-MAUWBMSJ.js.map
