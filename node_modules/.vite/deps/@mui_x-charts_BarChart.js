...
import {
  ...
  useZAxes,
  warnOnce
} from "./chunk-WJTEEQVS.js";
import {
  useThemeProps
} from "./chunk-DOJVNKEC.js";
import {
  IconButton_default
} from "./chunk-DHY7PHJJ.js";
import {
  refType_default
} from "./chunk-6U33DYRP.js";
import {
...
} from "./chunk-QXBN6BLQ.js";
import "./chunk-SFC7WDVE.js";
import {
  chainPropTypes
...
import {
  ...
  memoTheme_default,
  useDefaultProps
} from "./chunk-Z5FEENRV.js";
import "./chunk-2ZWTS3IA.js";
import {
  ownerDocument,
  useEventCallback_default
} from "./chunk-T4HF7CDM.js";
import {
  useForkRef
...
function BarLabel(inProps) {
  ...
  return (0, import_jsx_runtime.jsx)(BarLabelComponent, _extends({
    textAnchor,
    dominantBaseline,
...
function BarLabelItem(props) {
  ...
  return (0, import_jsx_runtime2.jsx)(Component, _extends({}, barLabelProps, barLabelOwnerState, {
    hidden,
...
true ? BarLabelItem.propTypes = {
   ...
   */
  barLabel: import_prop_types2.default.oneOfType([import_prop_types2.default.oneOf(["value"]), import_prop_types2.default.func]),
...
function BarLabelPlot(props) {
  ...
  return (0, import_jsx_runtime3.jsx)("g", {
    className,
    ...
    children: data.map(({
      ...
      width,
      height
    }) => (0, import_jsx_runtime3.jsx)(BarLabelItem, _extends({
      seriesId,
      dataIndex,
      value,
      color,
...
var useInteractionItemProps = (data, skip) => {
  ...
  const interactionActive = React4.useRef(false);
...
function AnimatedBarElement(props) {
  ...
  return (0, import_jsx_runtime4.jsx)("rect", _extends({}, other, {
...
var _excluded5 = ["id", "dataIndex", "classes", "color", "slots", "slotProps", "style", "onClick", "skipAnimation", "layout", "x", "xOrigin", "y", "yOrigin", "width", "height"];
function BarElement(props) {
  ...
  const itemIdentifier = React6.useMemo(() => ({
    type: "bar",
    seriesId: id,
    dataIndex
  }), [id, dataIndex]);
  ...
  const isFocused = useIsItemFocused(React6.useMemo(() => ({
    type: "bar",
    seriesId: id,
    dataIndex
  }), [id, dataIndex]));
...
true ? BarElement.propTypes = {
  ...
  layout: import_prop_types3.default.oneOf(["horizontal", "vertical"]).isRequired,
  ...
  xOrigin: import_prop_types3.default.number.isRequired,
  yOrigin: import_prop_types3.default.number.isRequired
} : void 0;
...
var selectorBarItemAtPosition = createSelector(selectorChartXAxis, selectorChartYAxis, selectorChartSeriesProcessed, function selectorBarItemAtPosition2({
  ...
  for (let stackIndex = 0; stackIndex < stackingGroups.length; stackIndex += 1) {
    ...
    for (const seriesId of seriesIds) {
      ...
      const barOffset = stackIndex * (barWidth + offset2);
      ...
      if (svgPointBandCoordinate >= bandBarMin && svgPointBandCoordinate <= bandBarMax) {
        ...
        const start2 = continuousAxis.scale(bar[0]);
        const end2 = continuousAxis.scale(bar[1]);
        if (start2 == null || end2 == null) {
          continue;
        }
        const continuousMin = Math.min(start2, end2);
        const continuousMax = Math.max(start2, end2);
...
function BarGroup(_ref) {
  ...
  if (skipAnimation) {
    return (0, import_jsx_runtime8.jsx)(PathGroup, _extends({}, props));
  }
  return (0, import_jsx_runtime8.jsx)(AnimatedGroup, _extends({}, props, {
    layout,
    xOrigin,
    yOrigin
  }));
...
function AnimatedGroup(_ref2) {
  ...
  if (layout === "horizontal") {
    animateChildren.push((0, import_jsx_runtime8.jsx)(AnimatedRect, {
      "data-orientation": "horizontal",
      x: drawingArea.left,
  ...
  return (0, import_jsx_runtime8.jsxs)(React10.Fragment, {
    ...
    }), (0, import_jsx_runtime8.jsx)(PathGroup, _extends({
...
function useRegisterPointerInteractions(getItemAtPosition, onItemEnter, onItemLeave) {
  ...
  const svgRef = useSvgRef();
  const store = useStore();
  const interactionActive = React11.useRef(false);
  const lastItemRef = React11.useRef(void 0);
...
function BatchBarPlot({
  ...
  const prevCursorRef = React12.useRef(null);
  const svgRef = useSvgRef();
  ...
  return (0, import_jsx_runtime9.jsx)(React12.Fragment, {
    children: completedData.map((series) => (0, import_jsx_runtime9.jsx)(SeriesBatchPlot, {
      series,
      borderRadius,
      skipAnimation
    }, series.seriesId))
...
var MemoFadedHighlightedBars = React12.memo(FadedHighlightedBars);
...
function SeriesBatchPlot({
  ...
  return (0, import_jsx_runtime9.jsxs)(React12.Fragment, {
    children: [(0, import_jsx_runtime9.jsx)(BarGroup, {
      className: classes.series,
      ...
      children: (0, import_jsx_runtime9.jsx)(BatchBarSeriesPlot, {
        processedSeries: series,
        borderRadius
      })
    }), (0, import_jsx_runtime9.jsx)(MemoFadedHighlightedBars, {
      processedSeries: series,
      borderRadius
    })]
  });
...
function BatchBarSeriesPlot({
  ...
  for (const [fill, dArray] of paths.entries()) {
    for (const d of dArray) {
      children.push((0, import_jsx_runtime9.jsx)("path", {
        fill,
        d
      }, i));
      i += 1;
...
function FadedHighlightedBars({
  ...
  if (seriesHighlightedItem != null) {
    siblings.push((0, import_jsx_runtime9.jsx)("path", {
...
function BarPlot(props) {
  ...
  return (0, import_jsx_runtime10.jsxs)(BarPlotRoot, {
    className: classes.root,
    children: [(0, import_jsx_runtime10.jsx)(BarElementPlot, _extends({
      completedData,
      masksData,
      ...
      borderRadius
    }, other)), completedData.map((processedSeries) => (0, import_jsx_runtime10.jsx)(BarLabelPlot, _extends({
...
true ? BarPlot.propTypes = {
   ...
   * @default 'svg-single'
   */
  renderer: import_prop_types4.default.oneOf(["svg-batch", "svg-single"]),
  /**
...
function ChartsSingleXAxisTicks(inProps) {
  ...
  return (0, import_jsx_runtime11.jsx)(React16.Fragment, {
...
function ChartsYAxisImpl(_ref) {
  let {
    axis
  } = _ref, inProps = _objectWithoutPropertiesLoose(_ref, _excluded12);
  const {
    scale: yScale,
    ordinalTimeTicks
...
var consumeThemeProps = (name, options, InComponent) => React25.forwardRef(function ConsumeThemeInternal(props, ref) {
  ...
  return (0, import_jsx_runtime21.jsx)(OutComponent, _extends({}, outProps, {
    classes,
    ref
  }));
});
...
var _excluded13 = ["type", "color", "className", "classes"];
...
var ChartsLabelMark = consumeThemeProps("MuiChartsLabelMark", {
  ...
  return (0, import_jsx_runtime22.jsx)(Root, _extends({
    className: clsx_default(classes?.root, className),
    ownerState: props,
    "aria-hidden": "true",
    ref
    ...
    children: (0, import_jsx_runtime22.jsx)("div", {
      ...
      children: typeof Component === "function" ? (0, import_jsx_runtime22.jsx)(Component, {
        className: classes?.fill,
        color
      }) : (0, import_jsx_runtime22.jsx)("svg", {
        viewBox: "0 0 24 24",
        preserveAspectRatio: type === "line" ? "none" : void 0,
        children: type === "circle" ? (0, import_jsx_runtime22.jsx)("circle", {
          className: classes?.fill,
          r: "12",
          cx: "12",
          cy: "12",
  ...
  if ("values" in tooltipData) {
    ...
    return (0, import_jsx_runtime23.jsx)(ChartsTooltipPaper, {
      ...
      children: (0, import_jsx_runtime23.jsxs)(ChartsTooltipTable, {
        ...
        children: [(0, import_jsx_runtime23.jsxs)(Typography_default, {
          component: "caption",
          ...
          children: tooltipData.values.map(({
            ...
            label: label2
          }) => (0, import_jsx_runtime23.jsxs)(ChartsTooltipRow, {
...
function ChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime24.jsx)(ChartsTooltipPaper, {
    ...
    children: tooltipData.map(({
      ...
      return (0, import_jsx_runtime24.jsxs)(ChartsTooltipTable, {
        className: classes.table,
        children: [axisValue != null && !mainAxis.hideTooltip && (0, import_jsx_runtime24.jsx)(Typography_default, {
          component: "caption",
          ...
          children: seriesItems.map(({
            ...
            return (0, import_jsx_runtime24.jsxs)(ChartsTooltipRow, {
              className: classes.row,
              children: [(0, import_jsx_runtime24.jsxs)(ChartsTooltipCell, {
                className: clsx_default(classes.labelCell, classes.cell),
                component: "th",
                children: [(0, import_jsx_runtime24.jsx)("div", {
                  className: classes.markContainer,
                  children: (0, import_jsx_runtime24.jsx)(ChartsLabelMark, {
                    type: markType,
                    color,
                    className: classes.mark
                  })
...
var Portal = React29.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React29.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
var PopperTooltip = React30.forwardRef(function PopperTooltip2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime25.jsx)(Root4, {
    ...rootProps,
...
var Popper3 = React31.forwardRef(function Popper4(inProps, ref) {
  ...
  return (0, import_jsx_runtime26.jsx)(PopperRoot, {
    as: component,
...
var _excluded14 = ["trigger", "position", "anchor", "classes", "children"];
...
function ChartsTooltipContainer(inProps) {
  ...
  const pointerAnchorEl = React33.useMemo(() => ({
  ...
  return (0, import_jsx_runtime27.jsxs)(React33.Fragment, {
    children: [svgRef.current && ReactDOM2.createPortal((0, import_jsx_runtime27.jsx)("rect", {
      ref: anchorRef,
      display: "hidden"
    }), svgRef.current), (0, import_jsx_runtime27.jsx)(NoSsr_default, {
      children: isOpen && (0, import_jsx_runtime27.jsx)(ChartsTooltipRoot, _extends({}, other, {
        className: classes?.root,
        open: isOpen,
...
function ChartsTooltip(props) {
  ...
  const classes = useUtilityClasses7(propClasses);
  return (0, import_jsx_runtime28.jsx)(ChartsTooltipContainer, _extends({}, props, {
    classes: propClasses,
...
var consumeSlots = (name, slotPropName, options, InComponent) => {
  function ConsumeSlotsInternal(props, ref) {
    ...
    const _useSlotProps = useSlotProps_default({
      ...
      ownerState: {}
    }), originalOutProps = _objectWithoutPropertiesLoose(_useSlotProps, _excluded26);
  ...
  return React34.forwardRef(ConsumeSlotsInternal);
};
...
var _excluded16 = ["children", "className", "classes"];
...
var _excluded17 = ["direction", "onItemClick", "className", "classes"];
...
}, React36.forwardRef(function ChartsLegend2(props, ref) {
...
var _excluded18 = ["gradientId", "direction", "classes", "className", "rotate", "reverse", "thickness"];
...
var _excluded19 = ["minLabel", "maxLabel", "direction", "axisDirection", "axisId", "rotateGradient", "reverse", "classes", "className", "gradientId", "labelPosition", "thickness"];
...
var ContinuousColorLegend = consumeThemeProps("MuiContinuousColorLegend", {
  ...
  return (0, import_jsx_runtime33.jsxs)(RootElement2, _extends({
    ...
    ownerState: props,
    children: [reverse ? maxComponent : minComponent, (0, import_jsx_runtime33.jsx)("li", {
...
var _excluded20 = ["direction", "classes", "className", "markType", "labelPosition", "axisDirection", "axisId", "labelFormatter", "onItemClick"];
  ...
  return (0, import_jsx_runtime34.jsx)(RootElement3, _extends({
    ...
    children: orderedColors.map(({
      ...
      return (0, import_jsx_runtime34.jsx)("li", {
        children: (0, import_jsx_runtime34.jsxs)(Element2, {
          role: onItemClick ? "button" : void 0,
          type: onItemClick ? "button" : void 0,
          onClick: (
            // @ts-ignore onClick is only attached to a button
...
function ChartsYHighlight(props) {
  ...
  return axisYValues.map(({
    ...
    return (0, import_jsx_runtime35.jsxs)(React40.Fragment, {
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime39.jsx)(React43.Fragment, {
    children: xTicks.map(({
      value,
      offset: offset2
    }) => !instance.isXInside(offset2) ? null : (0, import_jsx_runtime39.jsx)(GridLine, {
      y1: start2,
      y2: end2,
      x1: offset2,
      x2: offset2,
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime40.jsx)(React44.Fragment, {
    children: yTicks.map(({
      value,
      offset: offset2
    }) => !instance.isYInside(offset2) ? null : (0, import_jsx_runtime40.jsx)(GridLine, {
      y1: offset2,
      y2: offset2,
      x1: start2,
      x2: end2,
...
var _excluded21 = ["vertical", "horizontal"];
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime44.jsx)(LoadingOverlay, _extends({}, props.slotProps?.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = props.slots?.noDataOverlay ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime44.jsx)(NoDataOverlay, _extends({}, props.slotProps?.noDataOverlay));
  }
  return null;
}
...
// node_modules/@mui/x-charts/esm/internals/plugins/featurePlugins/useChartVisibilityManager/isIdentifierVisible.js
...
// node_modules/@mui/x-charts/esm/internals/plugins/featurePlugins/useChartVisibilityManager/useChartVisibilityManager.selectors.js
...
var selectorIsItemVisibleGetter = createSelectorMemoized(selectorVisibilityMap, (visibilityMap) => {
  return (seriesConfig, identifier) => isIdentifierVisible(visibilityMap, identifier, seriesConfig);
});

// node_modules/@mui/x-charts/esm/internals/plugins/featurePlugins/useChartVisibilityManager/visibilityParamToMap.js
...
// node_modules/@mui/x-charts/esm/internals/plugins/featurePlugins/useChartVisibilityManager/useChartVisibilityManager.js
...
// node_modules/@mui/x-charts/esm/BarChart/useBarChartProps.js
var _excluded29 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "axisHighlight", "grid", "children", "slots", "slotProps", "skipAnimation", "loading", "layout", "onItemClick", "highlightedItem", "onHighlightChange", "borderRadius", "barLabel", "className", "hideLegend", "showToolbar", "brushConfig", "renderer"];
var useBarChartProps = (props) => {
  ...
  const defaultBandXAxis = React46.useMemo(() => [{
  ...
  const defaultBandYAxis = React46.useMemo(() => [{
  ...
  const seriesWithDefault = React46.useMemo(() => series.map((s) => _extends({
    type: "bar"
  }, s, {
    layout: hasHorizontalSeries ? "horizontal" : "vertical"
  })), [hasHorizontalSeries, series]);
  const defaultXAxis = hasHorizontalSeries ? void 0 : defaultBandXAxis;
  const processedXAxis = React46.useMemo(() => {
    if (!xAxis) {
      return defaultXAxis;
    }
  ...
  const processedYAxis = React46.useMemo(() => {
    if (!yAxis) {
      return defaultYAxis;
    }
...
var ChartsSlotsContext = React47.createContext(null);
if (true) ChartsSlotsContext.displayName = "ChartsSlotsContext";
function useChartsSlots() {
  const context = React47.useContext(ChartsSlotsContext);
  if (context == null) {
...
function ChartsSlotsProvider(props) {
  ...
  return (0, import_jsx_runtime45.jsx)(ChartsSlotsContext.Provider, {
    value,
    children
  });
}
...
var _excluded30 = ["children", "localeText", "plugins", "seriesConfig", "slots", "slotProps"];
...
function ChartDataProvider(props) {
  ...
  return (0, import_jsx_runtime46.jsx)(ChartProvider, _extends({}, chartProviderProps, {
    children: (0, import_jsx_runtime46.jsx)(ChartsLocalizationProvider, {
      localeText,
      children: (0, import_jsx_runtime46.jsx)(ChartsSlotsProvider, {
        slots,
        slotProps,
...
var _excluded31 = ["width", "height", "margin", "children", "series", "colors", "dataset", "desc", "onAxisClick", "highlightedAxis", "onHighlightedAxisChange", "disableVoronoi", "voronoiMaxRadius", "onItemClick", "disableAxisListener", "highlightedItem", "onHighlightChange", "sx", "title", "xAxis", "yAxis", "zAxis", "rotationAxis", "radiusAxis", "skipAnimation", "seriesConfig", "plugins", "localeText", "slots", "slotProps", "experimentalFeatures", "enableKeyboardNavigation", "brushConfig", "onHiddenItemsChange", "hiddenItems"];
...
function useComponentRenderer(defaultElement, render, props, state = {}) {
  ...
  if (render) {
    ...
    return React50.cloneElement(render, props);
  }
  return React50.createElement(defaultElement, props);
}
...
var ToolbarContext = React51.createContext(void 0);
if (true) ToolbarContext.displayName = "ToolbarContext";
function useToolbarContext() {
  const context = React51.useContext(ToolbarContext);
  if (context === void 0) {
...
function ToolbarContextProvider({
  ...
  const [focusableItemId, setFocusableItemId] = React51.useState(null);
  const focusableItemIdRef = React51.useRef(focusableItemId);
  const [items, setItems] = React51.useState([]);
  const getSortedItems = React51.useCallback(() => items.sort(sortByDocumentPosition), [items]);
  const findEnabledItem = React51.useCallback((startIndex, step, wrap = true) => {
  ...
  const registerItem = React51.useCallback((id, itemRef) => {
    setItems((prevItems) => [...prevItems, {
      id,
      ref: itemRef
    }]);
  }, []);
  const unregisterItem = React51.useCallback((id) => {
    setItems((prevItems) => prevItems.filter((i) => i.id !== id));
  }, []);
  const onItemKeyDown = React51.useCallback((event) => {
    if (!focusableItemId) {
      return;
    }
    const sortedItems = getSortedItems();
  ...
  const onItemFocus = React51.useCallback((id) => {
    if (focusableItemId !== id) {
      setFocusableItemId(id);
    }
  }, [focusableItemId, setFocusableItemId]);
  const onItemDisabled = React51.useCallback((id) => {
    const sortedItems = getSortedItems();
  ...
  return (0, import_jsx_runtime47.jsx)(ToolbarContext.Provider, {
    value: contextValue,
    children
  });
}
...
function useRegisterToolbarButton(props, ref) {
  ...
  const previousDisabled = React52.useRef(disabled);
  React52.useEffect(() => {
  ...
  const previousAriaDisabled = React52.useRef(ariaDisabled);
  React52.useEffect(() => {
...
var _excluded32 = ["className", "render"];
...
var Toolbar = React53.forwardRef(function Toolbar2(_ref, ref) {
  let {
    className,
    render
  } = _ref, other = _objectWithoutPropertiesLoose(_ref, _excluded32);
  ...
  return (0, import_jsx_runtime48.jsx)(ToolbarContextProvider, {
    children: element
  });
});
...
var _excluded33 = ["render", "onKeyDown", "onFocus", "disabled", "aria-disabled"];
var _excluded210 = ["tabIndex"];
var ToolbarButton = React54.forwardRef(function ToolbarButton2(props, ref) {
  const {
    render
...
function ChartsWrapper(props) {
  ...
  return (0, import_jsx_runtime50.jsx)(Root3, {
    ref: chartRootRef,
    ownerState: props,
    sx,
...
function FocusedBar(props) {
  ...
  return (0, import_jsx_runtime51.jsx)("rect", _extends({
    fill: "none",
    stroke: (theme.vars ?? theme).palette.text.primary,
    strokeWidth: 2,
    x: x - 3,
...
var BarChart = React57.forwardRef(function BarChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiBarChart"
  });
  ...
  return (0, import_jsx_runtime52.jsx)(ChartDataProvider, _extends({}, chartDataProviderProps, {
    children: (0, import_jsx_runtime52.jsxs)(ChartsWrapper, _extends({}, chartsWrapperProps, {
      children: [props.showToolbar && Toolbar3 ? (0, import_jsx_runtime52.jsx)(Toolbar3, _extends({}, props.slotProps?.toolbar)) : null, !props.hideLegend && (0, import_jsx_runtime52.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime52.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
        children: [(0, import_jsx_runtime52.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime52.jsxs)("g", _extends({}, clipPathGroupProps, {
          children: [(0, import_jsx_runtime52.jsx)(BarPlot, _extends({}, barPlotProps)), (0, import_jsx_runtime52.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime52.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps)), (0, import_jsx_runtime52.jsx)(FocusedBar, {})]
        })), (0, import_jsx_runtime52.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime52.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
      })), !props.loading && (0, import_jsx_runtime52.jsx)(Tooltip, _extends({}, props.slotProps?.tooltip))]
    }))
  }));
});
...
true ? BarChart.propTypes = {
   ...
   * ```
   */
  hiddenItems: import_prop_types30.default.arrayOf(import_prop_types30.default.shape({
    ...
    type: import_prop_types30.default.oneOf(["bar"]).isRequired
  })),
  /**
   * If `true`, the legend is not rendered.
   */
   ...
   */
  onHiddenItemsChange: import_prop_types30.default.func,
  /**
   ...
   * @default 'svg-single'
   */
  renderer: import_prop_types30.default.oneOf(["svg-batch", "svg-single"]),
  /**
